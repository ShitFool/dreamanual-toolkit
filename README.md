...
AIGC:
  ...
  Label: '1'
  ProduceID: '7134631d-18bf-47a1-92ad-885fcd239679'
  PropagateID: '7134631d-18bf-47a1-92ad-885fcd239679'
  ReservedCode1: 'c77ef944-494d-4818-b616-5524bc94dfcc'
  ReservedCode2: 'c77ef944-494d-4818-b616-5524bc94dfcc'
---
...
| **Search Push** | 文章发布/更新时自动推送链接到百度、Bing、IndexNow | 百度提交链接（baidu-submit-link） |
...
文章发布或更新时，自动推送链接到搜索引擎，提升收录效率。

- **百度推送**：通过百度普通收录 API 推送，需配置 Token（百度搜索资源平台获取）
- **Bing 推送**：通过 Bing Webmaster API 推送，支持单条和批量，需配置 API Key
- **IndexNow 推送**：通过 IndexNow 协议一次通知多个搜索引擎，Key 自动生成并提供验证路由
- 发布文章后延迟 30 秒推送，不阻塞发布流程
- 首次启用时自动从旧插件 `baidu-submit-link` 迁移设置
