...
?>
<div class="wrap drea-rm-wrap">
    <h1><?php echo esc_html__( '角色管理', 'dreamanual-toolkit' ); ?></h1>
    <p class="description"><?php echo esc_html__( '管理 WordPress 用户角色和能力。点击角色查看详情和编辑能力。', 'dreamanual-toolkit' ); ?></p>

    <!-- Toast -->
    <div class="drea-rm-toast-container" id="drea-rm-toast-container"></div>

    <!-- 操作栏 -->
    <div class="drea-rm-actions">
        <button type="button" class="button" id="drea-rm-add-btn"><?php echo esc_html__( '添加角色', 'dreamanual-toolkit' ); ?></button>
    </div>
    ...
    <div class="drea-rm-roles-panel">
        <table class="wp-list-table widefat fixed striped drea-rm-roles-table">
            ...
            <tbody id="drea-rm-roles-tbody">
                <tr><td colspan="5" style="text-align:center;color:#646970;"><?php echo esc_html__( '加载中...', 'dreamanual-toolkit' ); ?></td></tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="drea-rm-dialog-overlay" id="drea-rm-dialog-overlay" style="display:none;">
        <div class="drea-rm-dialog">
            ...
            <div class="drea-rm-dialog-footer">
                <button type="button" class="button button-primary" id="drea-rm-dialog-confirm"><?php echo esc_html__( '确认', 'dreamanual-toolkit' ); ?></button>
                <button type="button" class="button" id="drea-rm-dialog-cancel"><?php echo esc_html__( '取消', 'dreamanual-toolkit' ); ?></button>
            </div>
        </div>
    </div>
    ...
    <div class="drea-rm-detail-panel" id="drea-rm-detail-panel" style="display:none;">
        <div class="drea-rm-detail-header">
            ...
            <button type="button" class="button" id="drea-rm-detail-close"><?php echo esc_html__( '关闭', 'dreamanual-toolkit' ); ?></button>
        </div>
        <div class="drea-rm-detail-body">
            <h3><?php echo esc_html__( '能力矩阵', 'dreamanual-toolkit' ); ?></h3>
            <p class="description"><?php echo esc_html__( '勾选该角色应具备的能力。', 'dreamanual-toolkit' ); ?></p>
            <div id="drea-rm-caps-grid" class="drea-rm-caps-grid"></div>
            <p class="submit">
                <button type="button" class="button button-primary" id="drea-rm-save-caps"><?php echo esc_html__( '保存能力', 'dreamanual-toolkit' ); ?></button>
            </p>
        </div>
    </div>
</div>
